        ...
        <section className="py-12 bg-color">
            <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
                <div className="text-center my-8">
                    ...
                    <p className="mt-4 text-lg text-color font-pt-serif">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 pt-8">
                    ...
                    {
                        featurs.map(feature => (
                            <div key={feature._id} className="bg-color bg-opacity-20 rounded-lg shadow-lg p-6 relative overflow-hidden">
                                ...
                                <div className="mb-8">
                                    <h3 className="text-2xl font-semibold text-color font-pt-serif">{feature?.feature}</h3>
                                    <p className="mt-4 text-color font-pt-serif">{feature?.description}</p>
                                </div>
                                <div className="mb-8">
                                    <img src={feature?.img} alt="Feature photo" className="rounded-md w-[328px] h-[154px]" />
                                </div>
                                <ul className="mb-8 space-y-4 text-color">
                                    {
