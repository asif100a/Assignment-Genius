        ...
        <section className="bg-color py-12">
            <div className="container flex flex-col items-center h-auto px-6 mx-auto">
                ...
                <div className="w-full md:w-[448px] box-border p-6 rounded-2xl mt-8">
                    <div onClick={handleGoogleSignIn} className="flex items-center justify-center w-full mt-4 transition-colors duration-300 transform border-2 border-gray-600 rounded-lg input-btn hover:text-gray-50 hover:cursor-pointer">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <p className="text-xs text-center text-color font-pt-serif uppercase">or login with email</p>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-6">
                        <input type="submit" value={'Sign in'} className="w-full px-6 py-3 tracking-wide text-color font-bold capitalize font-pt-serif ease-in-out transition-colors duration-300 transform input-btn hover:text-white btn-border hover:cursor-pointer" />
                        </div>
                    </form>

                    <div className="text-center mt-6">
                        <p className="text-sm text-center font-pt-serif text-gray-500"><span>Do not have an account?</span> <Link to={'/register'} className="text-blue-600 hover:underline">Register now</Link></p>
                    </div>
                </div>
            </div>
        </section>
