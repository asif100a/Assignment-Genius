...
const Faq = () => {
    return (
        <section className="dark:bg-gray-900 py-12 bg-gray-50">
            <div className="container px-6 mx-auto">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-800 dark:text-white capitalize text-center">Frequently asked questions(FAQ)</h1>

                <div className="grid grid-cols-1 w-fit gap-8 mx-auto mt-8 lg:mt-16 md:grid-cols-2 xl:grid-cols-3">
                    {/* FAQ-1 */}
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">What do I do if I encounter technical issues while submitting an assignment online?</h1>
                            
                            <img src={faqImage1} alt="Faq image 1" className='my-3 w-[380px] h-[236px] rounded-md' />
                    ...
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">How do I know when my assignment is due?</h1>
                            
                            <img src={faqImage2} alt="Faq image 2" className='my-3 w-[380px] h-[236px] rounded-md' />
                    ...
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">Can I submit multiple files for a single assignment ?</h1>
                            
                            <img src={faqImage3} alt="Faq image 3" className='my-3 w-[380px] h-[236px] rounded-md' />
                    ...
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">How will I receive feedback on my submitted assignments ?</h1>
                            
                            <img src={faqImage4} alt="Faq image 4" className='my-3 w-[380px] h-[236px] rounded-md' />
                    ...
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">What criteria are used for grading assignments ?</h1>
                            
                            <img src={faqImage5} alt="Faq image 5" className='my-3 w-[380px] h-[236px] rounded-md' />
                    ...
                    <div className='w-[424px] faq-border'>
                        <div>
                            <h1 className="text-xl font-semibold text-gray-700 dark:text-white">Where can I find additional resources to help with my assignments ?</h1>
                            
                            <img src={faqImage6} alt="Faq image 6" className='my-3 w-[380px] h-[236px] rounded-md' />
