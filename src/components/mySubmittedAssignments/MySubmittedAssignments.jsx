...
const MySubmittedAssignments = () => {
    ...
    return (
        <section className="bg-gray-50 min-h-[calc(100vh-413.6px)]">
            <div className="container px-4 mx-auto py-12">
                <div className="">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl text-center font-semibold font-noto-serif text-gray-800 dark:text-white capitalize">My submitted assignments</h2>
                </div>
