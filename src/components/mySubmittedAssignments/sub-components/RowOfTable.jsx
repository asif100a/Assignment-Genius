            ...
            <td className="px-4 py-4 text-sm font-medium text-color whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                    ...
                    <div className="flex items-center gap-x-2">
                        ...
                        <div>
                            <h2 className="font-medium font-pt-serif text-color">{examinee?.displayName}</h2>
                            <p className="text-sm font-normal font-pt-serif text-color">{examinee?.email}</p>
                        </div>
                    </div>
                </div>
            </td>
            <td className="px-12 py-4 text-sm font-medium text-color whitespace-nowrap">
                <h4 className='font-pt-serif text-color'>{title}</h4>
            </td>
